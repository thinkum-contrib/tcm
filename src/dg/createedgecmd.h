...
// 02111-1307, USA.
//-----------------------------------------------------------------------------
#ifndef _CREATEEDGECMD_H
#define _CREATEEDGECMD_H
...
/// command class for creating edges.
class CreateEdgeCmd: public Command {
/*@Doc: {\large {\bf scope:} diagram} */
public:
	///
	CreateEdgeCmd(GShape *from);
	///
	virtual ~CreateEdgeCmd();
	///
	...
	void Abort();
	///
	const char *GetName() const {return "create edge";}
protected:
	///
...
private:
	...
	friend class SCDCreateAndLineCmd;
};
#endif
