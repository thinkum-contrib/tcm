...
/// box class with equal height and width.
class Square: public NodeShape {
/*@Doc: {\large {\bf scope:} diagram} */
public:
	///
	Square(ShapeView *v, Grafport *g, double x, double y);
	///
        Square(const NodeShape &n);
	///
