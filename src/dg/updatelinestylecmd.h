...
// 02111-1307, USA.
//-----------------------------------------------------------------------------
#ifndef _UPDATELINESTYLECMD_H
#define _UPDATELINESTYLECMD_H
...
class UpdateLineStyleCmd: public Command {
/*@Doc: {\large {\bf scope:} diagram} */
public:
	///
	UpdateLineStyleCmd(ShapeView *view, LineStyle::Type s);
	///
	virtual ~UpdateLineStyleCmd();
	///
	void Execute();
	///
	void UnExecute();
