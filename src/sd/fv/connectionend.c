...
ConnectionEnd::ConnectionEnd(SNGraph *g, Subject *n1, Subject *n2): 
		C1Edge(g, n1, n2) { }

bool ConnectionEnd::SetConstraint(const string *s) {
...
bool ConnectionEnd::ParseCardConstraint(const string *str) {
