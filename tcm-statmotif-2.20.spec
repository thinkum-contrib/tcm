...
# This is the static motif specfile.
#
...
Prefix: /opt/tcm
Provides: tcm
#Patch0: tcm-2.20-dynamic.patch	// patch not needed in tcm-statmotif version
%description
...
#%patch0 -p0		// patch not needed in tcm-statmotif version
%build
make config 
make depend 
make execs
